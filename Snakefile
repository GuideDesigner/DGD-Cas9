...
=============================
NOTE (if you are on the 'main' branch): this Snakefile calls into Python
scripts (DGD.py, Accessory/*.py, etc.) that live on the 'full-pipeline'
branch, not here. Run `git checkout full-pipeline` first -- see this
repo's main-branch README for details.
